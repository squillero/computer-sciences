    ...
    for r in range(len(maze)):
        for c in range(len(maze[r])):
            if maze[r][c] == ' ':
                ...
                if r > 0 and maze[r-1][c] == ' ': maze_dictionary[(r, c)].add((r-1, c))
                if r < len(maze)-1 and maze[r+1][c] == ' ': maze_dictionary[(r, c)].add((r+1, c))
                if c > 0 and maze[r][c-1] == ' ': maze_dictionary[(r, c)].add((r, c-1))
                if c < len(maze[r])-1 and maze[r][c+1] == ' ': maze_dictionary[(r, c)].add((r, c+1))
