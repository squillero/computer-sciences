...
def main():
    ...
    if len(max_city_names) == 1:
        print(f"The city where more trolls have been reported is {max_city_names[0]}, with {max_city_trolls:,} trolls.")
    elif len(max_city_names) == 2:
        print(f"The two cities where more trolls have been reported are {max_city_names[0]} and {max_city_names[1]}, with {max_city_trolls:,} trolls.")
    else:
        max_city_names[-1] = 'and ' + max_city_names[-1]
        print(f"The cities where more trolls have been reported are {', '.join(max_city_names)}, all with {max_city_trolls:,} trolls.")
